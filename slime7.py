...
def place_food(labyrinth, food_positions):
    ...
    # Lebensmittel an gespeicherten Positionen platzieren
    for x, y in food_positions:
        labyrinth[x, y] = FOOD

# Agent-Umgebung
class SlimeAgent:
    def __init__(self, labyrinth, start_position):
        self.labyrinth = labyrinth
        self.start_position = start_position
        self.reset()

    def reset(self):
        # Zurücksetzen auf Startposition
...
def train_agent(labyrinth, epochs=100):
    ...
    # Initiale Lebensmittelpositionen zufällig auswählen
    ...
    # Initiale Startposition des Schleims festlegen
    ...
    def update(frame):
        ...
        if agent.has_collected_all_food():
            ...
            # Essen an den ursprünglichen Positionen neu platzieren
            place_food(labyrinth, initial_food_positions)
            # Schleim-Agent zurücksetzen
            agent.reset()
